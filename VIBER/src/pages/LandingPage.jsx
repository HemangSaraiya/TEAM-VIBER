    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <nav className="px-8 py-6 max-w-7xl mx-auto flex items-center justify-between z-10 relative">
        ...
        <div className="flex gap-4">
          <Link to="/login" className="px-6 py-2.5 border border-white/20 rounded-full text-sm hover:bg-white/10 transition-all">
            Login
          </Link>
          <Link to="/signup" className="px-6 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-full text-sm font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all">
            Join CamPus
          </Link>
        </div>
      </nav>
      ...
      <section className="relative z-10 px-8 max-w-7xl mx-auto pt-20 pb-32 text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/10 border border-purple-500/20 rounded-full text-purple-300 mb-8"
        >
        ...
        >
          ...
          <span className="block text-4xl md:text-6xl lg:text-7xl text-zinc-400">Connected</span>
        </motion.h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            to="/signup"
            className="group flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-2xl font-semibold text-lg shadow-2xl hover:shadow-purple-500/50 transition-all"
          >
            Join CamPus
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link to="/login" className="px-8 py-4 border-2 border-white/20 rounded-2xl hover:bg-white/10 transition-all">
            Explore
          </Link>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="group p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-purple-500/30 hover:bg-white/10 transition-all backdrop-blur-xl"
            >
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
